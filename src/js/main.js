...
(function(){
  ...
  // Active nav link is now set server-side (base.njk compares page.url to
  // each nav item), since URLs are clean paths (e.g. /about/) rather than
  // filenames — no client-side match needed.
